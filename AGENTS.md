...
- **Current phase:** Phased MVP implementation complete (Phases 0–7), with post-release scoped race-question and provider-backed race-catalog slices integrated. Deployment remains intentionally pending explicit permission and hosted credentials.
