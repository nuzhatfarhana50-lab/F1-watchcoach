...
- **Current phase:** Phased MVP implementation complete (Phases 0–7), with a post-release scoped race-question interface integrated on the home screen. Deployment and hosted-integration activation remain intentionally pending explicit permission and credentials.
