...
const ids = {
  ...
  hamiltonExplanation: "91000000-0000-4000-8000-000000000001",
  verstappenExplanation: "91000000-0000-4000-8000-000000000002",
  dutchExplanation: "91000000-0000-4000-8000-000000000003",
  britishDutchConnection: "92000000-0000-4000-8000-000000000001",
  dutchBritishConnection: "92000000-0000-4000-8000-000000000002",
} as const;
...
export const canonicalRaceFixtures = validateFixtureCollection({
  ...
  moments: [
    ...
    },
    {
      ...
      concepts: [{ id: ids.tyreChoiceConcept, slug: "tyre-offset", name: "Tyre offset", category: "tyres", definition: "A deliberate difference in tyre compound or age that gives cars contrasting pace and durability at the same point in a race.", sourceIds: [ids.sourceF1British, ids.sourceFiaBritish] }],
      explanation: { id: ids.verstappenExplanation, slug: "canonical", whatHappened: "Verstappen recovered to Norris and passed him for second late in the race.", whyItHappened: "Red Bull selected the durable hard tyre, which retained performance as Norris's soft tyres faded.", whyItMatters: "The different compound choice turned a late deficit into second place.", watchNext: "Compare compound age and lap times before deciding whether the chasing car's faster pace will last.", conceptIds: [ids.tyreChoiceConcept], sourceIds: [ids.sourceF1British, ids.sourceFiaBritish] },
      connections: [], media: [{ id: "82000000-0000-4000-8000-000000000002", provider: "officialF1", providerId: "1803935535997055584", kind: "video", title: "Verstappen powers past Norris for P2", url: "https://www.formula1.com/en/video/2024-british-grand-prix-verstappen-powers-past-norris-for-p2.1803935535997055584", attribution: "Formula 1", sourceIds: [ids.sourceF1VerstappenVideo] }], sourceIds: [ids.sourceF1British, ids.sourceFiaBritish],
    },
    {
